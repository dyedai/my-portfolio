    ...
    <div>
      <div className="flex h-screen w-full flex-col lg:flex-row">
        <div className="lg:w-1/2 h-ful text-white lg:px-8 pt-2">
          ...
          <a className="underline  text-blue-600 mx-2" href="https://github.com/jphacks/tk_2422" target="_blank">
            GitHub
          </a>
        </div>
        ...
        <div className="lg:w-1/2 h-full lg:overflow-y-scroll">
          <div className="grid grid-cols-1 gap-4 p-4">
            <Image src="/images/luggpal/login.png" alt="login" className="w-full h-auto" width={2400} height={1600} />
            <Image src="/images/luggpal/home.png" alt="home" className="w-full h-auto" width={2400} height={1600} />
            <Image src="/images/luggpal/home2.png" alt="home2" className="w-full h-auto" width={2400} height={1600} />
            <Image src="/images/luggpal/keeper.png" alt="keeper" className="w-full h-auto" width={2400} height={1600} />
            <Image src="/images/luggpal/registrar.png" alt="registar" className="w-full h-auto" width={2400} height={1600} />
            <video src="/images/luggpal/demo.mp4" controls autoPlay loop playsInline className="w-full h-auto" width="2400" height="1600" />
          </div>
        </div>
      </div>
    </div>
